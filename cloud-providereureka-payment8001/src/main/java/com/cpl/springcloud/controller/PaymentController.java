...
import com.cpl.springcloud.entities.CommonResult;
...
public class PaymentController {
    ...
    public Object discovery(){
        ...
        for (ServiceInstance instancd : instances) {
            log.info(instancd.getServiceId() + "\t" + instancd.getHost() + "\t" + instancd.getPort() + "\t" + instancd.getUri());
        }
